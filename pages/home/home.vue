<template>
	<view class="">
		<view class="top">
			<view class="search"><image class="image" src="../../static/icon/ziyuan.png"></image>uni—app vue react</view>
		</view>
		...
		<view v-if="active==0" class="page">
			...
			<image src="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-huang1514993615/4844fa70-8a23-11ea-b244-a9f5e5565f30.png" mode=""></image>
		</view>
